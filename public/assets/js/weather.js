...
$.ajax({url: weatherURL, method: "GET"})
	...
	window.myWidgetParam ? window.myWidgetParam : window.myWidgetParam = [];  window.myWidgetParam.push({id: 3,cityid: '5404555',appid: '194fa6305bc1a1fb55714a954b6da066',units: 'imperial',containerid: 'openweathermap-widget-3',  });  (function() {var script = document.createElement('script');script.async = true;script.src = "https://openweathermap.org/themes/openweathermap/assets/vendor/owm/js/weather-widget-generator.js";var s = document.getElementsByTagName('script')[0];s.parentNode.insertBefore(script, s);  })();
